...
class Variable(Protocol):
    ...
    def is_constant(self) -> bool:
        """Check if this variable is a constant (i.e., it does not require gradient computation)."""
        ...

    @property
    def parents(self) -> Iterable["Variable"]:
        """The parent variables of this variable in the computation graph."""
        ...

    def chain_rule(self, d_output: Any) -> Iterable[Tuple["Variable", Any]]:
        """Apply the chain rule to compute gradients for this variable."""
        ...
...
class Context:
    ...
    def saved_tensors(self) -> Tuple[Any, ...]:
        """Return the saved values as a tuple."""
